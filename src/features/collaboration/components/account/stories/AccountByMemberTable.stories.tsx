...
type MyArgTypes = Partial<Record<keyof ComponentProps<typeof AccountByMemberTable>, ArgTypes[string]>>;
...
const Template: ComponentStory<typeof AccountByMemberTable> = ({ ...props }) => {
